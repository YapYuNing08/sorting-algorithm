...
int main(int argc, char* argv[]){
    ...
    for(const Record& r:data){
        if(ht.table[ht.hf(r.key)].chainLen==1){ bestKey=r.key; break; }
    }
    ...
    string outFile="hash_table_search_"+base+".txt";
